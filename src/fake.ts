...
const capabilities: ModelRuntimeCapabilities = Object.freeze({ structuredTools: true, structuredToolsFidelity: "native", outputTokenLimitFidelity: "native", streaming: false, abort: true, usage: true });
